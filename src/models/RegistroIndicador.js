...
const rIndicatorSchema = new Schema(
    {
        IND0000001: {
            type: String,
            required: false,
        ...
        VAR0000001_IND0000001: {
            ...
            required: false,
            unique: false
        }, VAR0000003_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000004_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000005_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000006_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000007_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000008_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000009_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000010_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000011_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000012_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000013_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000014_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000015_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000016_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000017_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000018_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000019_IND0000001: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000020_IND0000001: {
            type: Number,
            required: false,
            unique: false
        },
        VAR0000001_IND0000002: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000002_IND0000002: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000003_IND0000002: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000004_IND0000002: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000005_IND0000002: {
            type: Number,
            required: false,
            unique: false
        }, VAR0000006_IND0000002: {
            type: Number,
            required: false,
            unique: false
...
module.exports = model("registroindicadores", rIndicatorSchema);
